...
namespace DistanceConverter {
    public class MeterConverter : ConverterBase {
        public override bool IsMyUnit(string name) => name.ToLower() == "meter" || name == UnitName;
    ...
    public class FeetConverter : ConverterBase {
        public override bool IsMyUnit(string name) => name.ToLower() == "feet" || name == UnitName;
    ...
    public class InchConverter : ConverterBase {
        public override bool IsMyUnit(string name) => name.ToLower() == "inch" || name == UnitName;
    ...
    public class YardConverter : ConverterBase {
        public override bool IsMyUnit(string name) => name.ToLower() == "yard" || name == UnitName;
    ...
    public class MileConverter : ConverterBase {
        public override bool IsMyUnit(string name) => name.ToLower() == "mile" || name == UnitName;
    ...
    public class KiloMeterConverter : ConverterBase {
        public override bool IsMyUnit(string name) => name.ToLower() == "kilometer" || name == UnitName;
